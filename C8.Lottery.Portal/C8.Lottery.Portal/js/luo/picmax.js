...
$(function () {
    $('#article-body img').on('click', function () {
        ...
        var top = width * h / w / -2;
        var left = width / -2;
        $('body').append('<div class="layer_bg"><div id="picbox" class="picbox"></div><img id="picimg" src="' + src + '" width="80%" style="top:50%;position:absolute;margin-top:' + top + 'px;left:50%; margin-left:' + left + 'px"></div>');
        $('.layer_bg').show();

        picmax.init({
            'famian': 'picbox', "img": 'picimg', 'end': function () {
                _this.transform['x'] = 0;
                _this.transform['y'] = 0;
                _this.updateElementTransform();
            }, 'tap': function (e) {
