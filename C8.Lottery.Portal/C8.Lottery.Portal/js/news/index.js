                    ...
                    for (var i = 0; i < data.TypeList.length; i++) {
                        ...
                        if (entity.TypeName == "6彩") {
                            if (entity.Id == currentlType) {
                                tempHtml += '<li class="current" data-id="' + entity.Id + '"><a href="/lhcNews.html?v=1.1">' + entity.TypeName + '</a></li>';
                                continue;
                            }
                            tempHtml += '<li data-id="' + entity.Id + '"><a href="/lhcNews.html?v=1.1">' + entity.TypeName + '</a></li>';
                        } else {
                            if (entity.Id == currentlType) {
